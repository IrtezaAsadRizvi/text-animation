...
export const ANIMATION = {
    INPUT: 'text: We can think of 2 x 8 as %2% groups of %8% circles.; animation_type: text; animation: bounce; animation_duration: 500; animation_pause: 400; background_color: #1F2937; text_color: white',
    DURATION: 700,
    PAUSE: 200,
    PREVIEW_BOX: {
        BG_COLOR: '#1F2937',
